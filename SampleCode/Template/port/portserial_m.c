...
#define MODBUS_UART_PORT								(UART1)
#define MODBUS_UART_PORT_RST							(UART1_RST)
#define MODBUS_UART_PORT_IRQn							(UART13_IRQn)
#define MODBUS_UART_PORT_IRQHandler						(UART13_IRQHandler)
